import { FooterLinks, SocialNetworks } from '../../const.ts';
    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__container">
          <div className="footer__logo-wrapper"><a className="footer__logo logo" href="main.html"><img
            className="logo__img" width="70" height="70" src="./img/svg/logo.svg" alt="Логотип" /></a>
            <div className="socials footer__socials">
              <ul className="socials__list">

                { SocialNetworks.map((network) =>
                  <li className="socials-item" key={network}>
                    <a className="socials__link" href={`https://www.${network}.com/`} aria-label={`Мы в ${network}`}>
          ...
          <section className="footer__nav-section footer__nav-section--links">
            ...
            <ul className="footer__nav-list">
              ...
              { FooterLinks.map((linkItem) => (
                <li className="footer__nav-list-item" key={linkItem}>
